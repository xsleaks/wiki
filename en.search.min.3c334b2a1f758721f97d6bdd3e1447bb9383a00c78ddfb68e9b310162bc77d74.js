...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.716488491a9b354520db2f02efb1cee7fda6c7adb3883ecf7c828b48dbb2a6b3.js',function(){input.required=false;search();});}
