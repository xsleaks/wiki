...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.8e82c1f60a3a3e55bf38c50c536d3fee0b92c1df9418d6df30e727caf8fab14a.js',function(){input.required=false;search();});}
