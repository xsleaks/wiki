...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.a0de53255ca0fca155fc8bedabfe11033f87a5fc602a1d4d13509617d108baa0.js',function(){input.required=false;search();});}
