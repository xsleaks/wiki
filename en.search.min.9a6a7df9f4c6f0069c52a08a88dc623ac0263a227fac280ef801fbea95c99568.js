...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.443f97f32601ab1b9cedc7b90396a115da523833172a93bcdbe4aac0ebf0a899.js',function(){input.required=false;search();});}
