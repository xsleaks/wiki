...
This may also leak when the connection happend and the browser can limits per connection and on how many connections are allowed per host, for example 6 per host. [^2]
```javascript
