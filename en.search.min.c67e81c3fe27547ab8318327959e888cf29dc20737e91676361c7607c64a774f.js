...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.e0fbc53c59a52a6d2428fd7267851e06833898951d03e548e3a0a2b67a4e9cd0.js',function(){input.required=false;search();});}
