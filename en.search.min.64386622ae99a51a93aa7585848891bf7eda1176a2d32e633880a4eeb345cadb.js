...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.cdc828e353decaf93281d4aee4a30a0a102010c8959c9e1abd1c0e6332bd7c1a.js',function(){input.required=false;search();});}
