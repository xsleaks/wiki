...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.79600277411a2f1873be88283c9a350b7615ee845f6a6391836237b24186f0eb.js',function(){input.required=false;search();});}
